...
/** 
 * DAO for table "PrinterBean".
*/
public class PrinterBeanDao extends AbstractDao<PrinterBean, Long> {

    public static final String TABLENAME = "PrinterBean";

    /**
     * Properties of entity PrinterBean.<br/>
    ...
    public PrinterBeanDao(DaoConfig config) {
        super(config);
    }
    
    public PrinterBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PrinterBean\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PrinterBean\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, PrinterBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, PrinterBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public PrinterBean readEntity(Cursor cursor, int offset) {
        PrinterBean entity = new PrinterBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, PrinterBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(PrinterBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(PrinterBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(PrinterBean entity) {
