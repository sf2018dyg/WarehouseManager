...
/** 
 * DAO for table "OrdQitaoBean".
*/
public class OrdQitaoBeanDao extends AbstractDao<OrdQitaoBean, String> {

    public static final String TABLENAME = "OrdQitaoBean";

    /**
     * Properties of entity OrdQitaoBean.<br/>
    ...
    public OrdQitaoBeanDao(DaoConfig config) {
        super(config);
    }
    
    public OrdQitaoBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"OrdQitaoBean\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"OrdQitaoBean\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, OrdQitaoBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, OrdQitaoBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public OrdQitaoBean readEntity(Cursor cursor, int offset) {
        OrdQitaoBean entity = new OrdQitaoBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, OrdQitaoBean entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(OrdQitaoBean entity, long rowId) {
        return entity.getFOrdNo();
    }
    
    @Override
    public String getKey(OrdQitaoBean entity) {
        if(entity != null) {
            return entity.getFOrdNo();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(OrdQitaoBean entity) {
