package com.soonfor.warehousemanager.view.FlycoTabLayout_Lib;
...
import com.soonfor.warehousemanager.view.FlycoTabLayout_Lib.utils.FragmentChangeManager;
import com.soonfor.warehousemanager.view.FlycoTabLayout_Lib.utils.UnreadMsgUtils;
import com.soonfor.warehousemanager.view.FlycoTabLayout_Lib.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorColor = ta.getColor(R.styleable.CommonTabLayout_tl_indicator_color, Color.parseColor(mIndicatorStyle == STYLE_BLOCK ? "#4B6A87" : "#eb443a"));
        ...
        mUnderlineColor = ta.getColor(R.styleable.CommonTabLayout_tl_underline_color, Color.parseColor("#eb443a"));
        ...
        mDividerColor = ta.getColor(R.styleable.CommonTabLayout_tl_divider_color, Color.parseColor("#eb443a"));
        ...
        mTextSelectColor = ta.getColor(R.styleable.CommonTabLayout_tl_textSelectColor, Color.parseColor("#eb443a"));
        mTextUnselectColor = ta.getColor(R.styleable.CommonTabLayout_tl_textUnselectColor, Color.parseColor("#888888"));
...
//        NLogger.d("AAA", "mLastP--->" + mLastP.left + "&" + mLastP.right);
//        NLogger.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDividerWidth > 0) {
            ...
            DashPathEffect pathEffect = new DashPathEffect(new float[] { 8,4 }, 1);
            mDividerPaint.setPathEffect(pathEffect);
            for (int i = 0; i < mTabCount - 1; i++) {
                View tab = mTabsContainer.getChildAt(i);
                //canvas.drawLine(paddingLeft + tab.getRight(), mDividerPadding, paddingLeft + tab.getRight(), height - mDividerPadding, mDividerPaint);
                Path path = new Path();
                path.moveTo(paddingLeft + tab.getRight(), mDividerPadding);
                path.lineTo(paddingLeft + tab.getRight(), height - mDividerPadding);
