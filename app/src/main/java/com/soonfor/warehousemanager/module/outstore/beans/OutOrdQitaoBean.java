 ...
 * 类用途：齐套订单页
 */
@Entity(nameInDb = "OutOrdQitaoBean")
public class OutOrdQitaoBean {
    ...
    @Generated(hash = 638539994)
    public OutOrdQitaoBean(String fOrdNo, String fProdNo, String fTotalPackQty,
    ...
    @Generated(hash = 1081581679)
    public OutOrdQitaoBean() {
    }
