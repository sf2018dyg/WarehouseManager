 ...
 * 类用途：2)订单入库状况页
 */
@Entity(nameInDb = "OrdInStatusBean")
public class OrdInStatusBean {
    ...
    @Generated(hash = 799216841)
    public OrdInStatusBean(String fOrdNo, String fProdNo, String fTotalPackQty,
    ...
    @Generated(hash = 552870434)
    public OrdInStatusBean() {
    }
