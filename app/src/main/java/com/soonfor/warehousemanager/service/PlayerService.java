package com.soonfor.warehousemanager.service;
...
public class PlayerService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        try {
            ...
            if (msg == Tokens.PlayerMsg.PLAY_MSG) {
                play(0);
            } else if (msg == Tokens.PlayerMsg.PAUSE_MSG) {
                pause();
            } else if (msg == Tokens.PlayerMsg.STOP_MSG) {
                stop();
            }
        } catch (Exception e) {
        }
